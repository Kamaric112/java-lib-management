...
public class LoanService {
     ...
     */
    public static int createLoan(Loan loan) throws SQLException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            statement.setString(3, loan.getLoanDate().toString());
            statement.setString(4, loan.getDueDate().toString());
            statement.setInt(5, loan.isActive() ? 1 : 0);
            
            statement.executeUpdate();
            
            // Update book availability
            BookService.updateBookAvailability(loan.getBookId(), false);
